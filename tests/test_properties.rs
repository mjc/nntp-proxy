...
proptest! {
    ...
    fn prop_request_context_never_panics(s in ".*") {
        ...
        let _ = RequestContext::from_request_bytes(s.as_bytes());
    }
    ...
    fn prop_case_insensitive_known_commands(
        ...
        let upper_result = RequestContext::from_request_bytes(upper.as_bytes());
        let lower_result = RequestContext::from_request_bytes(lower.as_bytes());
    ...
    fn prop_trailing_line_ending_idempotent(s in "[A-Za-z0-9]+( [A-Za-z0-9@.<>_-]+)?") {
        ...
        let result1 = RequestContext::from_request_bytes(with_crlf.as_bytes());
        let result2 = RequestContext::from_request_bytes(s.as_bytes());
    ...
    fn prop_article_by_msgid_requires_brackets(
        ...
        let request = RequestContext::from_request_bytes(with_brackets.as_bytes());
    ...
    fn prop_request_context_deterministic(s in ".*") {
        ...
        let result1 = RequestContext::from_request_bytes(s.as_bytes());
        let result2 = RequestContext::from_request_bytes(s.as_bytes());
