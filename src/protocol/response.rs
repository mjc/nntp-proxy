...
mod tests {
    ...
    fn test_boundary_status_codes() {
        ...
        assert_eq!(NntpResponse::parse_status_code(b"1234 Invalid\r\n"), Some(123));
    }
    ...
    fn test_auth_required_edge_cases() {
        ...
        assert!(ResponseParser::is_auth_required(b"381 Password required\r\n"));
        assert!(ResponseParser::is_auth_required(b"480 Authentication required\r\n"));
    ...
    fn test_auth_success_edge_cases() {
        // Standard success
        assert!(ResponseParser::is_auth_success(b"281 Authentication accepted\r\n"));
        ...
        // Failures
        assert!(!ResponseParser::is_auth_success(b"381 Password required\r\n"));
        assert!(!ResponseParser::is_auth_success(b"481 Authentication failed\r\n"));
        assert!(!ResponseParser::is_auth_success(b"482 Authentication rejected\r\n"));
    }

    #[test]
    fn test_multiline_terminator_variations() {
        // Standard terminator
        assert!(NntpResponse::has_multiline_terminator(b"line1\r\nline2\r\n.\r\n"));
    ...
    fn test_success_response_edge_cases() {
        ...
        assert!(ResponseParser::is_success_response(b"211 Group selected\r\n"));
        assert!(ResponseParser::is_success_response(b"220 Article follows\r\n"));
        assert!(ResponseParser::is_success_response(b"281 Auth OK\r\n"));
        ...
        assert!(ResponseParser::is_success_response(b"381 Password required\r\n"));
        
        // 4xx codes (client error)
        assert!(!ResponseParser::is_success_response(b"400 Bad request\r\n"));
        assert!(!ResponseParser::is_success_response(b"430 No such article\r\n"));
        
        // 5xx codes (server error)
        assert!(!ResponseParser::is_success_response(b"500 Internal error\r\n"));
        assert!(!ResponseParser::is_success_response(b"502 Service unavailable\r\n"));
    }
