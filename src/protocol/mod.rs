...
pub use responses::{
    ...
    COMMAND_NOT_SUPPORTED_STATELESS, COMMAND_SYNTAX_ERROR, CONNECTION_CLOSING, CRLF, GOODBYE,
    MIN_RESPONSE_LENGTH, MODE_READER_UNAVAILABLE_AFTER_AUTH, MULTILINE_TERMINATOR, NO_SUCH_ARTICLE,
