...
fn test_utf8_in_responses() {
    ...
    assert_eq!(
        NntpResponse::parse_status_code(utf8_response),
    ...
    assert_eq!(
        NntpResponse::parse_status_code(utf8_auth),
...
fn test_response_with_binary_data() {
    ...
    assert_eq!(
        NntpResponse::parse_status_code(with_null),
        Some(StatusCode::new(200))
    );
    ...
    assert_eq!(
        NntpResponse::parse_status_code(with_high_bytes),
        Some(StatusCode::new(200))
    );
}
