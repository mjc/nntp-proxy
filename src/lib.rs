//! # NNTP Proxy Library
//!
//! A high-performance NNTP proxy server implementation with hybrid, stateful,
//! and per-command routing modes.
//!
//! ## Architecture
//!
...
//!
//! Response shape is represented by typed request metadata. Multiline response
//! framing and packed pending-byte handling are centralized in
//! `session::multiline_framing`.
