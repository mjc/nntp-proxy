...
impl BufferPool {
    ...
    /// through the same allocation fallback metric, but this method returns
...
mod tests {
    ...
    async fn test_try_acquire_reports_exhaustion_without_allocating() {
        ...
        assert!(after.regular_pool_fallback_allocations > before.regular_pool_fallback_allocations);
