...
in
{
  ...
  enterShell = ''
    ...
    echo "🦀 devenv loaded: $(rustc --version)"
    echo "Run 'scripts/quality-fast.sh' for the local quality gate."
    echo "Run './scripts/build-release.sh <version>' for cross-platform artifacts."
  '';
}
